...
/**
 * odp content extractor
 *
 * @author Stephan Wentz <stephan@wentz.it>
 */
class OdpExtractor implements ExtractorInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $content = new Content($this->readOdp($filename));

        return $content;
    }

    private function readOdp($filename)
    {
